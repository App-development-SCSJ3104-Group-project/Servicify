...
class Form extends React.Component{
 ...
 validateEmailFormat = (email) => {
  ...
  //   history.goBack();
  //   }
    const { formInputs, formButtons, type, leftSideBackgroundHeight, SubmitFormCallback, resetFormFields } = this.props;
    const { userInfo } = this.state;
const style = {
...
// const Form = ({ formInputs, formButtons, type, leftSideBackgroundHeight, SubmitFormCallback,resetFormFields }) => {
